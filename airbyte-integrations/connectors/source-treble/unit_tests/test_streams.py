...
import pytest
from source_treble.source import TrebleStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TrebleStream, "path", "v0/example_endpoint")
    mocker.patch.object(TrebleStream, "primary_key", "test_primary_key")
    mocker.patch.object(TrebleStream, "__abstractmethods__", set())
